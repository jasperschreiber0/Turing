  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontFamily: B, fontSize: 'clamp(88px, 13vw, 148px)', lineHeight: '0.88', letterSpacing: '2px' }}>
            <div>WHO'S</div>
            <div style={{ color: 'transparent', WebkitTextStroke: '2.5px var(--ink)' }}>THE</div>
            <div>
              <span style={{
                display: 'inline-block', background: 'var(--purple)', color: 'var(--ink)',
                padding: '0 10px', transform: 'rotate(-1.5deg)',
              }}>BOT?</span>
            </div>
          </div>
          <p style={{
            fontSize: '17px', fontWeight: 300, lineHeight: 1.65,
            color: 'var(--ink-soft)', maxWidth: '380px', marginTop: '24px',
          }}>
            Four players. One AI. Three minutes to figure out who — or what — you're talking to.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateRows: 'auto 1fr auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', borderBottom: '2px solid var(--ink)' }}>
          {([
            { pill: '🔍 ×2', bg: 'var(--purple)',  title: 'Detector', hint: 'Two of you hunting the AI' },
            { pill: '🤖 ×1', bg: 'var(--sky)',     title: 'The AI',   hint: 'Blend in, fool everyone' },
        ...
        {/* Chat preview */}
        <div style={{ background: 'var(--white)', padding: '24px 28px', display: 'flex', flexDirection: 'column', gap: '10px', borderBottom: '2px solid var(--ink)' }}>
            ...
            <div key={i} style={{
              ...
              <div>
                ...
                <span style={{
                  ...
                  color: 'var(--ink-soft)', background: 'var(--beige)',
